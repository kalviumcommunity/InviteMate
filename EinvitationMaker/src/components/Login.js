...
function Login() {
    ...
    const initValue = {
      ...
      const style = {
        // loginButtonOnly:{color: white , background-color : black}
      }
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="form">
      <div className="enterButtons">
        <div className='login'>
        <button id="loginButtonOnly">Login</button>
        <button id="registerButton" onClick={() => moveToRegisterPage()}>Register </button>
        </div>
      </div>
